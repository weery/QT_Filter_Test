...
QT_MOC_LITERAL(1, 7, 14), // "Filter_Changed"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 13), // "ChangeElement"
QT_MOC_LITERAL(4, 37, 1), // "x"
QT_MOC_LITERAL(5, 39, 1), // "y"
QT_MOC_LITERAL(6, 41, 5) // "value"

    },
    "Filter\0Filter_Changed\0\0ChangeElement\0"
    "x\0y\0value"
};
...
void Filter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Filter_Changed(); break;
        case 1: _t->ChangeElement((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< double(*)>(_a[3]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Filter::Filter_Changed)) {
                *result = 0;
                return;
            }
        }
